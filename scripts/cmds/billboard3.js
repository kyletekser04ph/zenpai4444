...
config: {
  name: "billboard3",
  author:"",// Convert By Goatbot Aminul sordar
   role: 0,
  shortDescription: "billboardv3",
  longDescription: "",
  category: "it's For Fun only",
  guide: "{pn}"
},
...
onStart: async function ({ api, event, args, client, __GLOBAL, usersData, threadsData }) {
	...
	let getPorn = (await axios.get(`https://i.imgur.com/u6Iczox.jpeg`, { responseType: 'arraybuffer' })).data;
	...
	ctx.drawImage(baseImage, 11, 12, canvas.width, canvas.height);
