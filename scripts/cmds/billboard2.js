...
config: {
  name: "billboard2",
  author:"Siam modified by Kylepogi",// Convert By Goatbot Aminul sordar
   role: 0,
  shortDescription: " ",
...
onStart: async function ({ api, event, args, client, __GLOBAL, usersData, threadsData }) {
	...
	let getPorn = (await axios.get(`https://i.imgur.com/cNCaz8E.jpeg`, { responseType: 'arraybuffer' })).data;
